 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | n/a  |      |  Esc |Space |Gui+ALT| |Enter |      | MO 2 | N/A  | RE2  |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
 ...
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |CAPS_WRD|   Z  |   X  |   C  |   V  |   B  | Tab  |      |  |Leader|PrtScr|   K  |   M  | ,  < | . >  | /  ? |  N/A   |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
...
KC_TRNS, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_MS_L, KC_MS_R,        KC_NO, KC_NO, KC_MRWD, KC_MFFD, KC_NO, KC_NO, KC_MS_L, KC_MS_R, KC_TRNS, 
        
                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2, KC_BTN3, KC_TRNS
        ),
 ...
 */
 ...
 [DOTA] = LAYOUT(
    ...
    KC_LCTL, KC_A, KC_X, KC_C, KC_D, KC_F, KC_NO, KC_F9,      TG(3), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
